...
function ceali_form_system_theme_settings_alter(&$form, \Drupal\Core\Form\FormStateInterface $form_state) {

    $theme_file = drupal_get_path('theme', 'ceali') . '/theme-settings.php';
    ...
    $form['#submit'][] = 'ceali_theme_settings_form_submit';
    ...
    $form['settings']['general_setting']['general_setting_tracking_code'] = array(
        ...
        '#default_value' => theme_get_setting('general_setting_tracking_code', 'ceali'),
    ...
    '#open' => FALSE,
     ...
     $form['settings']['general_setting']['layout_type'] = array(
        ...
        '#default_value' => theme_get_setting('layout_type', 'ceali'),
      ...
      $form['settings']['general_setting']['page_header_background']['page_header_background_image'] = array(
        ...
        '#default_value' => theme_get_setting('page_header_background_image','ceali'), 
    ...
    $form['settings']['logo']  = array(
     ...
     $form['settings']['logo']['logo_white_image'] = array(
        ...
        '#default_value' => theme_get_setting('logo_white_image','ceali'), 
...
// Header settings
    ...
    $form['settings']['header'] = array(
     ...
     $form['settings']['header']['header_layout'] = array(
        ...
        '#default_value' => theme_get_setting('header_layout', 'ceali'),
...
// Footer settings
    ...
    $form['settings']['footer'] = array(
     ...
     $form['settings']['footer']['footer_layout'] = array(
        ...
        '#default_value' => theme_get_setting('footer_layout', 'ceali'),
...
// Blog
    ...
    $form['settings']['blog']['blog_header_background_image'] = array(
        ...
        '#default_value' => theme_get_setting('blog_header_background_image','ceali'), 
    ...
    '#default_value' => theme_get_setting('shop_sidebar', 'ceali'),
   ...
   $form['settings']['blog']['blog_sidebar'] = array(
    ...
    '#default_value' => theme_get_setting('blog_sidebar', 'ceali'),
     ...
     $form['settings']['blog']['blog_layout'] = array(
        ...
        '#default_value' => theme_get_setting('blog_layout', 'ceali'),
    ...
    $form['settings']['blog']['blog_single']['blog_single_style'] = array(
        ...
        '#default_value' => theme_get_setting('blog_single_style', 'ceali'),
...
// custom css
    ...
    $form['settings']['custom_css']['custom_css'] = array(
        ...
        '#default_value' => theme_get_setting('custom_css', 'ceali'),
...
function ceali_theme_settings_form_submit(&$form, FormStateInterface $form_state) {
    ...
    if (isset($bg[$i]) && !empty($bg[$i])) {
          ...
          $file_usage->add($file1, 'ceali', 'theme', 1);
