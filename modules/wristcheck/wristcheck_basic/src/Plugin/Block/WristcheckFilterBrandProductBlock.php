 ...
 *
 * @Block(
 *  id = "wristcheck_filter_brand_product_block",
 *  admin_label = @Translation("Wristcheck filter brand product block"),
 * )
 */
class WristcheckFilterBrandProductBlock extends BlockBase  implements ContainerFactoryPluginInterface{
  ...
  public function build() {
    $build = [];
    $build['#theme'] = 'wristcheck_filter_brand_product_block';
