  ...
  public function build() {
    ...
    if(isset($ins_media['data'])){
      foreach ($ins_media['data'] as $vm): 
          ...
          $link = $vm["link"];
          $out .= '<div class="item"><a href="'.$img_2.'"><img src="'.$img_2.'" alt="Instagram Image"></a></div>';
      endforeach;
    }
    //kint($ins_media);
    
    return [
      '#markup' => '<div class="instagram-wrap popup-gallery"><div class="instagram-slider owl-carousel">' . $out . '</div></div>',
    ];
  }
